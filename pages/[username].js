  ...
  return data.user ? (
    <>
      ...
      <div className="w-full bg-light-primary_background dark:bg-[#000]">
        ...
        >
          <div
            className={`hidden lg:block flex-shrink-0 w-full lg:w-[14.5rem]`}
          >
            <SideMenu />
          </div>
            ...
            <div className="card flex-row flex-wrap gap-xlspacing py-xlspacing px-10">
              ...
              <div className="flex gap-spacing flex-wrap w-full">
                <div className="w-full md:w-[calc(100%/2-0.8rem)] xl:w-[calc(100%/3-0.85rem)] card px-6 py-4">
                  ...
                  {data.user?.bio?.about ? (
                    <p className="text-md font-light-paragraph_color dark:text-dark-paragraph_color italic">
                      {data.user.bio.about}
                    </p>
                  ) : (
                    <p className="text-md font-light-paragraph_color dark:text-dark-paragraph_color italic">
                      Your bio is empty. Tell the world who you are by writing a
                  ...
                  {data.user?.skills?.length > 0 ? (
                    <div className="flex flex-wrap gap-2">
                      {data.user.skills.map((skill) => (
                        <button className="card mb-0 px-4 py-2 inline">
                          {skill}
                        </button>
                      ))}
                    </div>
                    ...
                    <p className="text-md font-light-paragraph_color dark:text-dark-paragraph_color italic">
                      Your tech stack is empty. Tell the world what is your tech
                      stack.
                    </p>
                  )}
                </div>
